...
public class Pooflix {
    ...
    public void inicializarGreysAnatomy() {
       ...
       // ga.setAnio(2005);
        ...
        Temporada t2 = new Temporada(1, 2006);
        //t2.numero = 2;
        ...
        cap2.setDescripcion("Meredith busca gente para compartir la casa de su madre. Izzie ayuda a una mujer asiática cuya hija sin papeles de residencia tiene una grave enfermedad. Meredith visita el pabellón de maternidad y descubre un problema en uno de los bebés.");
        ...
        cap10.setDescripcion("Mientras que Meredith y Cristina discuten sus deficiencias en el bar Emerald city, Joe el camarero se derrumba. El Dr. Webber se recupera de su cirugía y pide a George que sea sus ojos y oidos. Addison mientras tanto comienza a adaptarse al hospital ya que ha venido a cubrir un caso.");

        t2.getEpisodios().add(cap10);

        Episodio cap11 = new Episodio(11, "Ya basta", 48);
        cap11.setDescripcion("La Sra. Adele Webber regresa de vacaciones para ayudar a recuperarse a su marido, el Dr. Webber, de su cirugía. George sigue estando con la enfermera Olivia, pero todavía siente algo por Meredith. Un accidente de coche trae una familia al hospital, lo que provoca que el padre de la familia (con pasado violento) necesite un trasplante por parte de su hijo que no está dispuesto a dárselo. La Dra. Bailey tiene que realizar una operación complicada.");
    ...
    public void inicializarLaCasaDePapel() {
        ...
        epi1.setDescripcion("El Profesor recluta a una joven experta en atracos y a otros siete delincuentes para llevar a cabo un gran asalto a la Fábrica Nacional de Moneda y Timbre.");

        temporada1.getEpisodios().add(epi1);

        Episodio epi2 = new Episodio(2, "Imprudencias letales", 49);
        epi2.setDescripcion("Raquel, la negociadora de rehenes, establece un primer contacto con el Profesor. La policía consigue una imagen de la cara de uno de los ladrones");

        temporada1.getEpisodios().add(epi2);

        Episodio epi16 = new Episodio(16, "Hemos vuelto", 48);
        epi16.setDescripcion("Desconsolada por el secuestro de Río, Tokio recurre al Profesor. Después de tramar un nuevo y osado plan para rescatarlo, solo queda reunir al resto de la banda.");
