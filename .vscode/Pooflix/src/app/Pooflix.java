...
public class Pooflix {
    ...
    public void inicializarGreysAnatomy() {
        ...
        Episodio cap10 = new Episodio();
        cap10.numero = 10;
        cap10.nombre = "Gotas de lluvia sobre mi cabeza";
        cap10.duracionEnMin = 49;
        ...
        Episodio cap11 = new Episodio();
        cap11.numero = 11;
        cap11.nombre = "Ya basta";
        cap11.duracionEnMin = 48;
    ...
    public void inicializarLaCasaDePapel() {
        ...
        epi1.numero = 1;
        epi1.nombre = "Efectuar lo acordado";
        ...
        epi2.duracionEnMin = 49;

        temporada1.episodios.add(epi2);

        Episodio epi16 = new Episodio();
        epi16.numero = 16;
        epi16.nombre = "Hemos vuelto";
